...
//
const BotName = 'BOT ./DhitoBOT.exe'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/inidhito/'; // Nama Instagramlu cok
const whatsapplu = '0812-2986-8475'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@inidhito`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@inidhito`)
})
